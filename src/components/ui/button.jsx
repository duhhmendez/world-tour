  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        ios: "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg hover:shadow-xl active:scale-95 transition-all duration-200",
        iosSecondary: "bg-white/90 backdrop-blur-sm text-gray-800 border border-white/20 shadow-md hover:shadow-lg active:scale-95 transition-all duration-200",
      },
      size: {
